...
public class AnimControler {
    ...
    public void initControler(int width, int height) {
        ...
        mFirCandle = new FireCandle(mRelativeX + mWidth / 6, mRelativeY + mHeight);
        ...
        mFirCandle.setFlameStateListener(new FireCandle.FlameStateListener() {
            @Override
