...
public class CandlesAnimeView extends View {
    ...
    public CandlesAnimeView(Context context) {
        this(context, null);
    }

    public CandlesAnimeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CandlesAnimeView(Context context, AttributeSet attrs, int defStyleAttr) {
